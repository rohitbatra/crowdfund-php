...
{!! Form::open(array('url'=>'user/update/profile','method'=>'post','class'=>'')) !!}
	...
	@include('modules.form.formgroup',['data'=>$user,'type'=>'text','label'=>'Username','id'=>'username','note'=>'Your user profile would be like <pre>user/profile/USERNAME</pre> ','required'=>true])
