<head>
	...
	@if(isset($styles))
		...
		@endforeach
	@else
		<link media="all" type="text/css" rel="stylesheet" href="http://poloniago.com/css/app.css">
		<link media="all" type="text/css" rel="stylesheet" href="http://poloniago.com/css/main.css">
	@endif
